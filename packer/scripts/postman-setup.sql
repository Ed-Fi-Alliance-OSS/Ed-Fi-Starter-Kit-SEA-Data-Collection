...
DECLARE @UserFullName varchar(150) = 'StarterKit Postman User'
DECLARE @UserEmailAddress varchar(150) = 'postman@sk.ed-fi.org'
DECLARE @ApplicationName nvarchar(255) = 'StarterKit Postman Application'
DECLARE @ClaimSetName nvarchar(255) = 'SIS Vendor'
DECLARE @ApiClientName nvarchar(50) = 'StarterKit Postman Api Client'
