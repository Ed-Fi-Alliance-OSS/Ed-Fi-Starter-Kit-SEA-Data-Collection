...
SELECT ssa.EntryDate, ssa.EducationOrganizationId, st.StudentUSI, sc.LocalEducationAgencyId, sc.SchoolId, sc.SchoolId
FROM edfi.Student st
JOIN edfi.StudentSchoolAssociation ssa ON st.StudentUSI = ssa.StudentUSI
JOIN edfi.School sc ON ssa.EducationOrganizationId = sc.SchoolId
